...
def run_module():
    ...
    module_args = dict(
        ...
        date_val=dict(type='str', required=True)
    )
    ...
    nasaurl = f"https://api.nasa.gov/planetary/earth/assets/?lon={ module.params['lon'] }&lat={ module.params['lat'] }&date={ module.params['date_val'] }&api_key={ module.params['apikey'] }"
